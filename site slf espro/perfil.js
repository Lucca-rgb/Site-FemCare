...
function checkPassword() {
    ...
    if (passwordInput === 'sos') {
        window.location.href = 'jessi_especial.html'; // Direciona para jessi_especial.html
    } else {
        window.location.href = 'jessi_saude.html'; // Direciona para jessi_saude.html
    }
}
...
function normalizeInput(input) {
    const synonyms = {
        "cadastrar": [
            "cadastro", "castro", "cadastra", "cadrastra", "cadstro", "cadrastr", "cadastar", "cadstrar", "cadastr", "cadatro", "cadstro", "cadatro", "csdastro"
        ],
        "preencher": [
            "preenchido", "preenche", "preencher", "prenchido", "preenchido", "preenchi", "preenchar", "preencahr", "preenchudo", "prenchido", "preencgido"
        ],
        "problemas": [
            "problemas", "dificuldades", "dificuldade", "problem", "problemas", "proplemas", "probelmas", "probrwmas", "probkemas", "provlemas"
        ],
        "senha": [
            "senha", "senhas", "chave", "senah", "senha", "sehna", "sena", "senh", "swnha", "senhs", "srnha"
        ],
        "agendar": [
            "agendar", "marcar", "reservar", "agendamento", "agendamento", "agend", "agenadar", "agenar", "agendamenti", "agrndamento", "agwndamento"
        ],
        "data": [
            "data", "datas", "horário", "informação", "data", "dat", "daata", "datra", "dsta", "dats", "dara"
        ],
        "dores": [
            "dores", "dor", "desconforto", "intenso", "dor aguda", "dore", "doro", "dores", "dorres", "dorws", "dpres"
        ],
        "gravidez": [
            "gravidez", "gestação", "nausea", "enjoo", "gravidez", "gravid", "gravidez", "gravez", "grsvidez", "gravudez", "gravidwz"
        ],
        "menstruação": [
            "menstruação", "colicas", "cólica", "sintomas menstruais", "período", "menstruacao", "menstruação", "menstrsacao", "menstruacao", "mwnstruacao", "mrnstruacao"
        ],
        "ansiedade": [
            "ansiedade", "estresse", "depressão", "saúde mental", "angústia", "ansied", "ansiedade", "ansiedada", "ansuedade", "ansiedadw"
        ],
        "funcionou": [
            "funcionou", "deu certo", "tá certo", "foi bem", "funcionou", "funcinou", "funcion", "funciona", "funcona", "funcionalismo", "foi bem", "foi legal", "funcioma", "fnciona"
        ],
        "hormonais": [
            "hormônio", "hormonoterapia", "hormonal", "hormônios", "endocrinologia", "terapia hormonal", "equilíbrio hormonal", "tratamento hormonal", "alterações hormonais"
        ]
    };
